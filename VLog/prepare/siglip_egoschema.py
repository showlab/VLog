...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', default="/blob/v-lqinghong/data/Ego_database/egoschema/videos/videos", help="Path to the input directory")
    parser.add_argument('--fps', type=int, default=2, help="Frames per second to extract")
    parser.add_argument('--output_dir', default="/blob/v-lqinghong/data/Ego_database/egoschema/siglip-so400m-patch14-384-fps2",  help="Path to the output directory")    
